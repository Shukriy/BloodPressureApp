...
public class Db {
	...
	/** Generic method for returning a doctor/patient user
	 * @param user Username of the user
	 * @param pass Password of the user
	 * @return The user. Returns null if no matching user is found.
	 */
	...
	/** This method returns a user matching the user ID
	 * @param id
	 * @return the user. Returns null if no match is found
	 */
	...
	/** Private method for returning the readings of a user
	 * @param userID User ID of the user
	 * @return An arraylist of all the readings of the specified user
	 * Preconditions: the specified user must be a patient
	 */
	 ...
	 * @return ArrayList of patients whom have completed their readings, belonging to the specified doctor.
	 * 	Preconditions: Specified user must be a doctor
	 */
	 ...
	 * Preconditions: All the instance variables of the user must be in the correct format (eg: date, time, dob etc)
	 */
	...
	/**
	 * @param d The doctor to be added
	 * Preconditions: All the instance variables of the user must be in the correct format (eg: date, time, dob etc)
	 ...
	 * Preconditions: All the instance variables of the reading must be in the correct format (eg: date, time, BP etc)
	 */
